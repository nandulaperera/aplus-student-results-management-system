...
<body class="text-center">
	<?php echo form_open("Register/registerUser","class='form-signin''");?>
		...
		if($this->session->flashdata("registration_success")){
			...
			if($this->session->flashdata("registration_error")){
				echo ("<h3 class='text-danger'>".$this->session->flashdata('registration_error')."</h3>");
			}
			echo('
		...
		<label class="mt-3">Have an account? <a href="Login">Login</a></label>
	<?php echo form_close();?>
